...
public class ArbreCoups {
    ...
    public ArbreCoups(Plateau pl, Joueur j1, Joueur j2, CoupTicTacToe node, int profondeur) {
        ...
        if(profondeur == 0){
            ...
            if (node == null || node.getJeton().getJoueur() == j1){
    ...
    public ArrayList<Coup> getListeCoups(Plateau pl, Joueur j){
    ...
    public ArrayList<Coup> getListeCoups() {
        ...
        for (ArbreCoups coupsPossibles : coupsPossibles) {
            listeCoups.add(coupsPossibles.coupNode);
        }
        return listeCoups;
    }
